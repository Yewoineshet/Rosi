            ...
            <div class="form-wrap">
              ...
              <form action="reg1.php" method="POST" style="max-width:500px;margin:auto">
                  ...
                  <div class="row">
                   ...
                   <div class="col-md-12 form-group">
                      ...
                      <span aria-hidden="true" style="color:red" >*</span>
                      <input type="" placeholder="country-xxxx-xxxxx"  name="Phonenumber" id="name" class="form-control py-2 ">
                   </div></div>
                  <div class="row">
                    <div class="col-md-12 form-group">
              ...
              <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <span aria-hidden="true" style="color:red" >*</span>
                      <input type="" name="Password" id="name" class="form-control py-2">
                    </div>
              </div>
                  <div class="row ml-1">                                    
                  <div class="row mb-5">
                  ...
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <a target="_blank" href="./clintReferance.php">Terms and conditions</a>
                     <span aria-hidden="true" style="color:red" >*</span>
                </div>
                  <div class="row justify-content-center">
                      <div class="column">
