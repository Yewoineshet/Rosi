    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
         ...
         <form method="POST" style="color: #757575;" enctype="multipart/form-data" action="tutorSignUp2.php" style="max-width:650px;margin:auto">
                <!--Header-->

                <div class="input-group mt-4">
                    <select name="eduStatus" required="Education Status" class="browser-default custom-select">
                        
                        <option selected>Education Status  <span aria-hidden="true" style="color:red" >*</span></option>
                ...
                <div class="input-group mt-4">
                    ...
                    <select name="experience" required="Work Exprience" class="browser-default custom-select" id="inputGroupSelect01">
                        
                        <option selected>Tutor Exprience<span aria-hidden="true" style="color:red">*</span></option>
                ...
                <div class="col-md-12 mt-3 form-group">
                    ...
                    <input name="school" required="Name of School, And Field of Study" type="text" id="name" class="form-control py-2">
                </div> 
                </div>
                ...
                <div class=" mt-4 input-group"><h6 class="pr-3 pt-1"><strong>Level to tutor</strong></h6>
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        ...
                        <label class="custom-control-label mx-3" for="defaultInline1">Kindergarten</label>
                    </div>
               ...
               <div class="col-md-12 form-group">
                ...
                <div class="input-group mt-4">
                    ...
                    <div class="custom-file">
                        <input name="cv" type="file"  required="Attach your CV" class="custom-file-input" id="inputGroupFile01"
                ...
                <div class="custom-control custom-checkbox mt-4">
                    <input type="checkbox" required="I agree to" class="custom-control-input" id="defaultUnchecked">
                   
                    <label class="custom-control-label" for="defaultUnchecked">I agree to</label>
                    <a target="_blank" href="./tutorReferance.php">Terms and conditions</a>
                     <span aria-hidden="true" style="color:red" >*</span>
                </div>

                 <div class="row justify-content-center">
                    <div class="col-md-6 mt-4 form-group">
                        <button name="regBtn" class="btn " type="submit" style="background-color:whitesmoke;text-color:white;margin-left:auto;margin-right:auto;display:block;margin-bottom:0%">Register</button>
                        <p style="color:green;"><?php echo $output; ?></p>
                    </div>
                     
                  </div>
                <p><a href="login2.php" class="font-weight-bold ml-1" style="color: black">Log In</a></p>
           </form>
